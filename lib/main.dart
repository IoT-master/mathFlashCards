...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Kira\'s Adding App'),
    );
  }
}
          ...
          children: <Widget>[
            Row(
              ...
              children: [
                ...
                Text('$_num1', style: const TextStyle(fontSize: 100)),
              ],
            ),
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                const Text('+', style: TextStyle(fontSize: 100)),
                Text('$_num2', style: const TextStyle(fontSize: 100)),
              ],
            ),
            const Text('-------------', style: TextStyle(fontSize: 100)),
            Text(
              _displayAnswer ? '$_numSum' : '???',
